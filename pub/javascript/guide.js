...
GuideJs.prototype = {
    ...
    setOptions: function (addOutline=true, addOverlay=true, outlineColor='rgb(18, 195, 248)', overlayOpacity=0.8, descriptsions, textHighlightColor='#ffff00', dist=20) {
    ...
    highlightElement: function (element) {
        ...
        if (this.elementHighlight.addOutline) {
            const {borderWidth, borderLine, borderColor} = this.elementHighlight
        ...
        if(this.elementHighlight.addOverlay) {
            ...
            const {overlayOpacity, overlayRGB} = this.elementHighlight
